...
export const pureAddUserCallback = (name: string, setUsers: (item: Array<UserType>) => void, users: Array<UserType>) => { // need to fix any
...
const HW3 = () => {
    const [users, setUsers] = useState<Array<UserType>>([{_id: v1(), name: 'ivan'}]) // need to fix any
